...
public:
   ...
   double            CONFIRMATION;
                     ...
                     ConfirmationIndicator(string symbol,ENUM_TIMEFRAMES timeframe);
...
//|                                                                  |
//+------------------------------------------------------------------+
ConfirmationIndicator::ConfirmationIndicator(string symbol,ENUM_TIMEFRAMES timeframe)
  {
   SYMBOL=symbol;
   TIMEFRAME=timeframe;
...
//|                                                                  |
//+------------------------------------------------------------------+
ConfirmationIndicator::~TVP_ConfirmationIndicator()
  {
  }
//+------------------------------------------------------------------+
void ConfirmationIndicator::getConfirmation(void)
  {
...
//+------------------------------------------------------------------+
void ConfirmationIndicator::FillBarShape()
  {
   double Heiken[];
   ArraySetAsSeries(Heiken,true);
   CopyBuffer(HandleHeiken,4,0,30,Heiken);
